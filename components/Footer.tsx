export default function Footer() {
  return (
    <footer className="bg-burgundy text-cream mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/episodes" className="hover:text-gold transition-colors">Episodes</a></li>
              <li><a href="/about" className="hover:text-gold transition-colors">About</a></li>
              <li><a href="/gallery" className="hover:text-gold transition-colors">Gallery</a></li>
              <li><a href="/community" className="hover:text-gold transition-colors">Ask Queen E</a></li>
            </ul>
          </div>
          
          <div>
            <h3 className="font-serif text-xl font-bold mb-4">Connect</h3>
        ...
        <div className="border-t border-cream/20 mt-8 pt-8 text-center text-sm">
          <p>Developed by <a href="https://www.mcbridetechservices.com" target="_blank" rel="noopener noreferrer" className="hover:text-gold transition-colors">McBride Tech Services</a></p>
        </div>
      </div>
    </footer>
  );
